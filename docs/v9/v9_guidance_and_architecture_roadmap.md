...
> **立项背景**：CASE-EPCL V8 系列在消费级显卡（RTX 3050Ti 4GB）的极端物理显存制约下，经过 10 个子版本的系统性攻坚，成功达成了预设的所有学术与工程指标（Test PPL 33.88, EMO_loss 2.1227, Acc 41.29%, Greedy Dist-2 16.71%, Sampling Unique 99.60%, Alignment 0.9189）。  
...
- **达标标准**：训练全程无 NaN/Inf，显存占用稳定在 14~18GB 之间，Test PPL 在无需任何额外技巧下直接打进 $\le 33.50$。
