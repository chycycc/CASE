...
| **V8.2 F 终局旗舰推荐版** ⭐ | **钟形余弦加权 (peak=1.3) + 偏置下限 0.10 + 走完退火 (Step 39,999)** | **37.09** | **32.83** | **40.97%** | 2.3458 | **16.79%** | **45.68%** (T=0.8) | **98.60%** | **0.9514** | **-0.0626** |
| **V8.2 F2 权衡对比组** | **强行提升 α=7.0 截断于 Step 33,999 (牺牲 1.05 点 PPL 换取 EMO_loss)** | **38.19** | **33.88** | **41.29%** | **2.1227** | **16.71%** | **47.04%** (T=0.8) | **99.60%** | **0.9189** | **-0.0622** |
